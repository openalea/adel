...
__name__ = 'openalea.adel.adelMons'
...
spitters_journalier_spitters_journalier = Factory(name='spitters_journalier',
                ...
                category='light',
                nodemodule='openalea.adel.adelMons.spitters_journalier',
...
write_groud_cover_write_groud_cover = Factory(name='write_groud_cover',
                ...
                nodemodule='openalea.adel.adelMons.write_groud_cover',
...
adel_sim_exp_adel_sim_exp = Factory(name='adel_sim_exp',
                ...
                category='Unclassified',
                nodemodule='openalea.adel.adelMons.adel_sim_exp',
...
write_graphtalPars_write_graphtalPars = Factory(name='write_graphtalPars',
                ...
                category='file',
                nodemodule='openalea.adel.adelMons.write_graphtalPars',
...
render_pov_render_pov = Factory(name='render_pov',
                ...
                nodemodule='openalea.adel.adelMons.render_pov',
...
write_dict_write_dict = Factory(name='write_dict',
                description='',
                category='data',
                nodemodule='openalea.adel.adelMons.write_dict',
...
can2pov_can2pov = Factory(name='can2pov',
                ...
                category='file',
                nodemodule='openalea.adel.adelMons.can2pov',
                nodeclass='can2pov',
...
ls_sim_ls_sim = Factory(name='ls_sim',
                ...
                category='Unclassified',
                nodemodule='openalea.adel.adelMons.ls_sim',
                nodeclass='ls_sim',
...
clean_can_clean_can = Factory(name='clean_can',
                ...
                category='Unclassified',
                nodemodule='openalea.adel.adelMons.clean_can',
                nodeclass='clean_can',
...
loc_pov_cam_loc_pov_cam = Factory(name='loc_pov_cam',
                ...
                category='Unclassified',
                nodemodule='openalea.adel.adelMons.loc_pov_cam',
...
_104476624 = CompositeNodeFactory(name='ls_cam',
   ...
   4: ('system', 'X'),
   5: ('openalea.adel.adelMons', 'loc_pov_cam')},
...
groupOutput_mais_groupOutput_mais = Factory(name='groupOutput_mais',
                ...
                category='data',
                nodemodule='openalea.adel.adelMons.groupOutput_mais',
...
visu_can_visu_can = Factory(name='visu_sen',
                ...
                category='',
                nodemodule='openalea.adel.adelMons.visu_can',
                nodeclass='visu_can',
...
ground_cover_ground_cover = Factory(name='ground_cover',
                ...
                category='Image',
                nodemodule='openalea.adel.adelMons.ground_cover',
...
compute_sen_compute_sen = Factory(name='compute_sen',
                ...
                category='modelling',
                nodemodule='openalea.adel.adelMons.compute_sen',
...
_104673328 = CompositeNodeFactory(name='batch_ground_cover',
   ...
   {'desc': '', 'interface': None, 'name': 'wait', 'value': None}],
                             ...
                             elt_factory={  2: ('openalea.functional', 'map'),
   3: ('openalea.python', 'range'),
   4: ('openalea.adel.adelMons', 'can2pov'),
   5: ('openalea.adel.adelMons', 'render_pov'),
   6: ('openalea.adel.adelMons', 'ground_cover'),
   7: ('openalea.data structure', 'int'),
   8: ('openalea.adel.adelMons', 'ls_cam'),
