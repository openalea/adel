...
sleep_sleep = Factory(name='sleep',
                ...
                description='',
                category='time',
                nodemodule='openalea.adel.training.sleep',
                nodeclass='sleep',
...
_150448656 = CompositeNodeFactory(name='TD simple wheat',
   ...
   4: ('openalea.adel.leaf', 'curve discretizer'),
   5: ('openalea.adel.io', 'mtg (params)'),
   7: ('openalea.data structure', 'int'),
   8: ('openalea.flow control', 'pool reader'),
   9: ('openalea.flow control', 'pool writer'),
   10: ('openalea.adel.geometry', 'symbols'),
   11: ('openalea.adel.leaf', 'curve discretizer'),
   12: ('openalea.adel.fitting', 'fit'),
   13: ('openalea.file', 'start'),
   14: ('openalea.training', 'sleep'),
   15: ('openalea.data structure', 'int'),
   16: ('openalea.training', 'compute distance'),
   17: ('openalea.adel.geometry', 'MTG Interpreter time'),
   18: ('openalea.function operator', 'function'),
   19: ('openalea.plantgl.edition', 'Curve2D'),
   20: ('openalea.flow control', 'rendez vous'),
   21: ('openalea.training', 'filter leaf sectors'),
   22: ('openalea.flow control', 'annotation'),
   23: ('openalea.data structure', 'int'),
   24: ('openalea.adel.parameterisation', 'MonoAxeWheat'),
   25: ('openalea.function operator', 'function'),
   26: ('openalea.adel.macro', 'plot'),
   27: ('openalea.adel.io', 'update thermal time'),
   28: ('openalea.numpy.creation', 'arange'),
   29: ('openalea.data structure', 'int'),
   30: ('openalea.file', 'filename'),
   31: ('openalea.training', 'get distances'),
   32: ('openalea.plantgl.edition', 'Curve2D'),
   33: ('openalea.adel.parameterisation', 'simple sr'),
   34: ('openalea.adel.parameterisation', 'simple xy'),
   35: ('openalea.adel.io', 'PairAsDict'),
